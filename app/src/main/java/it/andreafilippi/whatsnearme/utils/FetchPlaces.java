...
public class FetchPlaces extends AsyncTask<Void, MyPlace, List<Marker>> {
    ...
    private static final MyPlace[] testPlaces = {
            ...
            new MyPlace().setId("MPGA0000000000").setName("Museo Piazza Grande").setLat(43.5506926).setLng(10.3089171).setTags(List.of("Ciao", "Git", "Git pull", "Git fetch remote")),
            new MyPlace().setId("MPGAEDL0000000000").setName("Museo Piazza Grande e d'intorni Larghi Distese").setLat(43.6506926).setLng(10.3089171).setTags(List.of("Ciao", "Git", "Git pull", "Git fetch remote"))
    };
    ...
    protected List<Marker> doInBackground(Void... params) {
        ...
        if (x) {
            ...
            // TESTING
            for (MyPlace place : testPlaces) publishProgress(place);
        }
    ...
    @Override
    protected void onProgressUpdate(MyPlace... places) {
        super.onProgressUpdate(places);

        MyPlace place = places[0];
